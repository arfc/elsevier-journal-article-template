...
\begin{figure}[htbp!]
	...
	\end{center}
        \caption{\gls{EU} tails mass accumulation was simulated over time.}
	\label{fig:eu_tail}
\end{figure}
...
\begin{figure}[htbp!]
	...
	\end{center}
\caption{Total \gls{EU} fuel useage was simulated over time.}
	\label{fig:eu_fuel}
\end{figure}
...
\begin{figure}[htbp!]
	...
	\end{center}
	\caption{Fuel loaded into \glspl{SFR} was simulated in discrete batches over time.
	\label{fig:fuel}
\end{figure}
