...
\begin{tabularx}{\textwidth}{XrX}
			\hline
                        \textbf{Category} & \textbf{Value} & Specifics \\
                                          & \textbf{[MTHM]} & \\ \hline
                        UOX Loaded  & 154,237 & UOX used in EU reactors 1970-2050\\ 
			MOX Loaded  & 6,463  & MOX used in French reactors 1970-2050\\
                        Available used UOX (EU)  & 86,853  & Used EU (minus France) 
			...
			Tails  & 1,347,339  & (Tails generated) $-$ (Tails used for production of LWR MOX) \\ 
			Natural U Used  & 1,501,576  & \\ \hline
		\end{tabularx}
...
A total of about $1,350,000$ MTHM of tails and $86,000$ MTHM of
...
shown as a function of time. The large peak near 2020 is due to the German
...
approximately 929 tons of plutonium. Table \ref{tab:pu} lists the 
...
\begin{table}[h]
	...
	\begin{tabular}{lrr}
		...
		Pu240 & 0.232 & 230.69 \\ 
		Pu241 & 0.126 & 125.28 \\ 
		Pu242 & 0.0487 & 48.42 \\ \hline
		\textbf{Total} & \textbf{0.9358} & \textbf{929.42} \\ \hline
	\end{tabular}
