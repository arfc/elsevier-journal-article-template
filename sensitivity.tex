...
\begin{table}[h]
    \centering
    \caption {Two parameters were varied - the 
              lifetime of French \glspl{LWR} and the breeding ratio of \glspl{ASTRID} -
              to analyze their impact on the reprocessing demand during the transition.}
...
decreases the monthly \gls{LWR} \gls{UNF} reprocessing demand, as shown in figure \ref{fig:br_rep}.
