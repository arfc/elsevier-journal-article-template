...
\begin{figure}[!ht]
	...
	\subfloat{\includegraphics[width=.45\textwidth]{./images/sensitivity/5yr_ext.png}}\\
	\subfloat{\includegraphics[width=.45\textwidth]{./images/sensitivity/10yr_ext.png}}\quad
	\subfloat{\includegraphics[width=.45\textwidth]{./images/sensitivity/20yr_ext.png}}
