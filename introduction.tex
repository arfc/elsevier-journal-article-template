...
inventory in \gls{EU} member states in 2050, and analyzes a potential strategy of spent fuel
management.
...
\begin{figure}[htbp!]
        ...
        \end{center}
        \caption{French Transition Capacity}
        \label{fig:sfr_num}
\end{figure}
\FloatBarrier
...
French aggressive growth from 1975 to 2000. The decommissioned
\glspl{LWR} are replaced with \glspl{SFR}. Note the jump in
...
to have no effect on reprocessing viability. The cycle is illustrated in
\cref{diag:fc}.
