...
installed capacity in \gls{EU} nations.  The sudden capacity reductions in the 
2040s are caused by predicted facility retirements and nuclear phaseout plans by nations such as Germany and Belgium.  
...
more assembly line like projection if major components can mostly be built off site.
In any case, this analysis is to analyze 
