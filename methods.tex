...
The \gls{ASTRID} design's target lifetime is 60 tears \cite{gauche_generation_2012}.
However, we assume \glspl{ASTRID} will have lifetime extensions of 20 years,
to a total lifetime of 80 years. This assumption is based on the fact that
most French \glspl{LWR} have lifetime extensions.
