...
\section{Methodology}
We modeled the nuclear reactor operating
history in the \gls{EU} to the furthest foreseeable future.
In this simulation, the \gls{UNF} from \gls{EU} nations is stored for later use 
in French \glspl{SFR}.
France, in addition to its historical operation with \gls{MOX} production
