...
The sum of \gls{UNF} from Bulgaria, Slovakia, Czech Republic, Italy, Slovenia,
Belgium, Spain and Germany
provides enough \gls{UNF} for the simulated transition ($\approx 55,700$ MTHM). 
...
\begin{table}[h]
    ...
    \caption {\gls{EU} nations and their respective \gls{UNF} inventory.} 
                \begin{tabularx}{\textwidth}{llr}
                    ...
                    \textbf{Slovakia} & \textbf{Modest Growth} & \textbf{2,744}\\
